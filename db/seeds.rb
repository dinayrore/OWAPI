heroes = Hero.create([{ name: 'Ana', real_name: 'Ana Amari', age: '60',
                        ...
                        Egypt', affiliation: 'Formerly Overwatch', image: 'https://blzgdapipro-a.akamaihd.net/hero/ana/hero-select-portrait.png' },
                      { name: 'Bastion', real_name: 'SST Laboratories Siege
                        Automaton E54', age: '30', occupation: 'Battle
                        Automaton', base_of_operations: 'Unknown', affiliation:
                        'None', image:
                      ...
                      { name: 'D.Va', real_name: 'Hana Song', age: '19',
                        ...
                        'Mobile Exo-Force of the Korean Army', image: 'https://blzgdapipro-a.akamaihd.net/hero/dva/hero-select-portrait.png' },
                      { name: 'Genji', real_name: 'Genji Shimada', age: '35',
                        occupation: 'Adventurer', base_of_operations: 'Shambali
                        Monastery, Nepal', affiliation: 'Formerly Shimada Clan
                        and Overwatch', image:
                      ...
                      { name: 'Hanzo', real_name: 'Hanzo Shimada', age: '38',
                        ...
                        image: 'https://blzgdapipro-a.akamaihd.net/hero/hanzo/hero-select-portrait.png' },
                      { name: 'Junkrat', real_name: 'Jamison Fawkes', age: '25',
                        occupation: 'Anarchist, Theif, Demolitionist, Mercenary,
                        Scavenger', base_of_operations: 'Junkertown, Australia',
                        affiliation: 'Formerly Junkers', image:
                      ...
                      { name: 'Lúcio', real_name: 'Lúcio Correia dos Santos',
                        ...
                        affiliation: 'None', image:
                        'https://blzgdapipro-a.akamaihd.net/hero/lucio/hero-select-portrait.png' },
                      { name: 'McCree', real_name: 'Jesse McCree', age: '37',
                        occupation: 'Bounty Hunter', base_of_operations: 'Santa
                        Fe, New Mexico, USA', affiliation: 'Formerly Overwatch',
                        image: 'https://blzgdapipro-a.akamaihd.net/hero/mccree/hero-select-portrait.png' },
                      { name: 'Mei', real_name: 'Mei-Ling Zhou', age: '31',
                        occupation: 'Climatologist, Adventurer',
                        base_of_operations: "Formerly Xi'an, China",
                        affiliation: 'Formerly Overwatch', image:
                      ...
                      { name: 'Mercy', real_name: 'Angela Ziegler', age: '34',
                        ...
                        'Formerly Overwatch', image:
                        'https://blzgdapipro-a.akamaihd.net/hero/mercy/hero-select-portrait.png' },
                      { name: 'Pharah', real_name: 'Fareeha Amari', age: '32',
                        occupation: 'Security Chief', base_of_operations: 'Giza,
                        Egypt', affiliation: 'Heliz Security International',
                        image: 'https://blzgdapipro-a.akamaihd.net/hero/pharah/hero-select-portrait.png' },
                      { name: 'Reaper', real_name: 'Unknown', age: 'Unknown',
                        occupation: 'Mercenary', base_of_operations: 'Unknown',
                        affiliation: 'Unknown', image:
                      ...
                      { name: 'Reinhardt', real_name: 'Reinhardt Walhelm', age:
                        ...
                        image: 'https://blzgdapipro-a.akamaihd.net/hero/reinhardt/hero-select-portrait.png' },
                      ...
                      { name: 'Torbjörn', real_name: 'Torbjörn Lindholm', age:
                        ...
                        base_of_operations: 'Gothenburg, Sweden', affiliation:
                        'Formerly Overwatch', image:
                        'https://blzgdapipro-a.akamaihd.net/hero/torbjorn/hero-select-portrait.png' },
                      { name: 'Tracer', real_name: 'Lena Oxton', age: '26',
                        occupation: 'Adventurer', base_of_operations: 'London,
                        England', affiliation: 'Formerly Overwatch', image: 'https://blzgdapipro-a.akamaihd.net/hero/tracer/hero-select-portrait.png' },
                      { name: 'Widowmaker', real_name: 'Amélie Lacroix', age:
                        '33', occupation: 'Assassin', base_of_operations:
                        'Annecy, France', affiliation: 'Talon', image: 'https://blzgdapipro-a.akamaihd.net/hero/widowmaker/hero-select-portrait.png' },
                      ...
                      { name: 'Zarya', real_name: 'Aleksandra Zaranova', age:
                        ...
                        'Krasnoyarsk Front, Russia', affiliation: 'Russian
                        Defense Forces', image:
                      ...
                      { name: 'Zenyatta', real_name: 'Tekhartha Zenyatta', age:
                        ...
                        affiliation: 'Formerly The Shambali', image: 'https://blzgdapipro-a.akamaihd.net/hero/zenyatta/hero-select-portrait.png'},
                      { name: 'Sombra', real_name: 'Unknown', age: '30',
                        ...
                        image: 'https://blzgdapipro-a.akamaihd.net/hero/sombra/hero-select-portrait.png'}])

stats = Stat.create([{ health: 200, armor: 0, sheild: 0 },
...
weapons = Weapon.create([{ title: 'Biotic Rifle', hero: heroes.first,
                         ...
                         { title: 'Whole Hog (Ultimate)', hero: heroes[13],
                           ...
                           can crank out a stream of shrapnel that knocks back
                           enemies.', image: 'https://blzgdapipro-a.akamaihd.net/hero/roadhog/ability-whole-hog/icon-ability.png' },
